...
class FMPSDK:
    ...
    def financial_statement_lists(self):
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"financial-statement-symbol-lists"
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
        return json.loads(data)
    ...
    def income_statement_growth(self, limit: int = 120):
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"income-statement-growth/{self.symbol}"
        self.limit = limit
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
        return json.loads(data)
    ...
    def balance_sheet_statement_growth(self, limit: int = 120):
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"balance-sheet-statement-growth/{self.symbol}"
        self.limit = limit
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
        return json.loads(data)
    ...
    def cash_flow_statement_growth(self, limit: int = 120):
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"cash-flow-statement-growth/{self.symbol}"
        self.limit = limit
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
        return json.loads(data)
    ...
    def income_statement_as_reported(
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"income-statement-as-reported/{self.symbol}"
        self.limit = limit
        self.period = period
        if download:
            self.datatype = "csv"  # Only CSV is supported.
    ...
    def balance_sheet_statement_as_reported(
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"balance-sheet-statement-as-reported/{self.symbol}"
        self.limit = limit
        self.period = period
        if download:
            self.datatype = "csv"  # Only CSV is supported.
    ...
    def cash_flow_statement_as_reported(
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"cash-flow-statement-as-reported/{self.symbol}"
        self.limit = limit
        self.period = period
        if download:
            self.datatype = "csv"  # Only CSV is supported.
    ...
    def financial_statement_full_as_reported(
        ...
        [ {
            ...
            "sharebasedcompensationarrangementbysharebasedpaymentawardequityinstrumentsotherthanoptionsvestedinperiod" : 4.2088E7,
            "retainedearningsaccumulateddeficit" : 4.5898E10,
            "proceedsfrompaymentsforotherfinancingactivities" : -1.05E8,
            ...
            "sharebasedcompensationarrangementbysharebasedpaymentawardequityinstrumentsotherthanoptionsgrantsinperiod" : 3.6852E7,
            ...
            "sharebasedcompensationarrangementbysharebasedpaymentawardequityinstrumentsotherthanoptionsnonvestednumber" : 8.1517E7,
            ...
            "factorbywhicheachrsugrantedreducesandeachrsucanceledorsharewithheldfortaxesincreasessharesavailableforgrant" : 2.0,
            "increasedecreaseininventories" : 2.89E8,
            ...
            "sharebasedcompensationarrangementbysharebasedpaymentawardequityinstrumentsotherthanoptionsforfeitedinperiod" : 5402000.0,
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"financial-statement-full-as-reported/{self.symbol}"
        self.period = period
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
        return json.loads(data)
    ...
    def enterprise_values(
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"enterprise-values/{self.symbol}"
        self.period = period
        self.limit = limit
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
    ...
    def historical_stock_dividend(self):
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"historical-price-full/stock_dividend/{self.symbol}"
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
        return json.loads(data)
    ...
    def historical_stock_split(self):
        ...
        """
        self.__init_url_query_vars()
        self.url_path = f"historical-price-full/stock_split/{self.symbol}"
        response = urlopen(self.url)
        data = response.read().decode("utf-8")
        return json.loads(data)
