...
# print(f"Historical Daily Prices: {fmpsdk.historical_price_full(apikey=apikey, symbol=symbol, series_type='line')=}")
# print(f"Historical Daily Prices with Change and Volume: {fmpsdk.historical_price_full(apikey=apikey, symbol=symbol)=}")
# print(f"Historical Daily Prices with Change and Volume (Interval): {fmpsdk.historical_price_full(apikey=apikey, symbol=symbol, from_date='2020-12-01', to_date='2020-12-09')=}")
# print(f"Historical Daily Prices with Change and Volume (Time Series): {fmpsdk.historical_price_full(apikey=apikey, symbol=symbol, time_series=5)=}")
# print(f"Historical Daily Prices (Batch Stocks): {fmpsdk.historical_price_full(apikey=apikey, symbol=['AAPL', 'CSCO', 'MSFT'])=}")
# print(f"Historical Daily Prices (Batch Mutual Funds): {fmpsdk.historical_price_full(apikey=apikey, symbol=['JBFRX','BPLEX','VEVRX'])=}")
...
# print(f"Index: {fmpsdk.quote(apikey=apikey, symbol='IMOEX.ME')=}")
...
# print(f"Intraday Historical Stock Prices: {fmpsdk.historical_chart(apikey=apikey, symbol='^SSEC', time_delta='15min')=}")
# print(f"Historical Market Index: {fmpsdk.historical_price_full(apikey=apikey, symbol='^VIX')=}")
...
# print(f"Commodity Quote': {fmpsdk.quote(apikey=apikey, symbol=['ZGUSD', 'CLUSD', 'HGUSD'])=}")
# print(f"Historical Commodity Prices: {fmpsdk.historical_chart(apikey=apikey, symbol='ZGUSD', time_delta='5min')=}")
# print(f"Historical Daily Commodity Prices: {fmpsdk.historical_price_full(apikey=apikey, symbol='ZGUSD')=}")

# ETF
# print(f"Available ETFs': {fmpsdk.available_efts(apikey=apikey)=}")
# print(f"ETFs': {fmpsdk.etf_list(apikey=apikey)=}")
# print(f"ETF Quote': {fmpsdk.quote(apikey=apikey, symbol=['ZGUSD', 'CLUSD', 'HGUSD'])=}")
# print(f"Historical ETF Prices: {fmpsdk.historical_chart(apikey=apikey, symbol='ZGUSD', time_delta='5min')=}")
# print(f"Historical Daily ETF Prices: {fmpsdk.historical_price_full(apikey=apikey, symbol='ZGUSD')=}")
...
# print(f"Mutual Fund Quote': {fmpsdk.quote(apikey=apikey, symbol=['ZGUSD', 'CLUSD', 'HGUSD'])=}")
# print(f"Historical Mutual Fund Prices: {fmpsdk.historical_chart(apikey=apikey, symbol='ZGUSD', time_delta='5min')=}")
# print(f"Historical Daily Mutual Fund Prices: {fmpsdk.historical_price_full(apikey=apikey, symbol='ZGUSD')=}")
